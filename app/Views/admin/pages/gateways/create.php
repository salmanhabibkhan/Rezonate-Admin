        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('admin/gateways/store') ?>" method="post" id="gateway_form" enctype="multipart/form-data">

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Gateway Name</label>
                                        <input type="text" class="form-control" name="name" placeholder="Gateway Name" value="<?= old('name') ?>" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="currency" placeholder="Currency" value="<?= old('currency') ?>" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="rate" placeholder="Rate" value="<?= old('rate') ?>" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="minimum_amount" placeholder="Minimum Amount" value="<?= old('minimum_amount') ?>" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="maximum_amount" placeholder="Maximum Amount" value="<?= old('maximum_amount') ?>" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="fix_charge" placeholder="Fix Charge" value="<?= old('fix_charge') ?>" required>
