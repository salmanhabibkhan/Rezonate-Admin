        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-body">
                        <form action="<?= base_url('admin/games/update/'.$game['id']) ?>" method="post" id="create_game" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"><?= lang('Admin.game_title') ?></label>
                                        <input type="text" class="form-control" name="name" value="<?= $game['name'] ?>" placeholder="<?= lang('Admin.game_title') ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" rows="1" placeholder="<?= lang('Admin.game_description') ?>"><?= $game['description'] ?></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="url" placeholder="<?= lang('Admin.url') ?>" value="<?= $game['link'] ?>">
