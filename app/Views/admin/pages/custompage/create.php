                ...
                <div class="card card-primary table-card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <form method="post" action="<?= base_url('admin/custom-page/store') ?>" id="create-custompage">
                                <?php $validation = \Config\Services::validation(); ?>

                                <div class="form-group">
                                    <label for="page_title"><?= lang('Admin.page_title') ?></label>
                                    <input type="text" class="form-control" id="page_title" name="page_title" required placeholder="<?= lang('Admin.page_title_placeholder') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_title" name="meta_title" placeholder="<?= lang('Admin.meta_title_placeholder') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="meta_description" name="meta_description" rows="5" placeholder="<?= lang('Admin.meta_description_placeholder') ?>"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="page_content" name="page_content" placeholder="<?= lang('Admin.page_content_placeholder') ?>"></textarea>
                                </div>
