        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card card-primary">
                    <div class="card-body">
                        <form action="<?= base_url('admin/group-categories/update/'.$category['id'])?>" method="post" id="create_package">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?= base_url('admin/group-categories')?>" class="btn btn-danger" >  <?= lang('Admin.cancel') ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
