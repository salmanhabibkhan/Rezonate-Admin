...
<div class="row g-4">
    ...
    <ul class="clearfix m-0 p-1">
        ...
        <li class="active">
            <a href="<?= site_url('products/my-products') ?>">
                    ...
                    <?php foreach ($products as $product) : ?>
                        ...
                        <div class="row py-2 border-bottom">
                            ...
                            <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                ...
                                <div class="d-flex flex-column mt-4"><a class="btn btn-primary-soft btn-sm" href="<?= site_url('products/edit/'.$product['id']) ?>"><i class="bi bi-pencil"></i> Edit </a>
                                    <button class="btn btn-danger-soft btn-sm mt-2"><i class="bi bi-trash"></i> Delete</button>
                                </div>
                            </div>
