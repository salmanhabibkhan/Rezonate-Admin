                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php if(get_setting('paystack_public_key')!='' && get_setting('paystack_secret_key')!='' && get_setting('chck-paystack')==1 ):?>
                                <h5 class="card-title mb-3"><?= lang('Web.deposit_via_paystack') ?></h5>
                                <form id="" method="post" action="<?= site_url('paystack/create') ?>">
                                    ...
                                    <div class="form-group mt-3">
                                        <button type="submit" class="btn btn-success btn-block">
                                            <i class="bi bi-category"></i> <?= lang('Web.deposit_via_paystack') ?>
                                        </button>
                                    </div>
                                </form>
                                <?php else:?>
                                    <b class="text-danger"><?= lang('Web.paystack_not_activated') ?></b>
                                <?php endif;?>
