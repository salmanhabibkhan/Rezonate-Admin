...
!(function (t, e) {
  ...
  var y = {},
    ...
    k = ["success", "warning", "info", "question", "error"].reduce(function (
      t,
      e
    ) {
      return (t[e] = C + e), t;
    ...
    n &&
      (!(function (t, e) {
        "string" == typeof e
          ...
          : e ||
            ct([document.documentElement, document.body], A["no-backdrop"]);
      })(n, e.backdrop),
      (function (t, e) {
        if (!e) return;
        e in A
    ...
    qt = function (t, n, o) {
      if (o.inputLabel) {
        ...
        i.setAttribute("for", t.id),
          (i.className = r),
          "object" === e(o.customClass) && ct(i, o.customClass.inputLabel),
  ...
  (_t.text =
    ...
    _t.month =
      function (t, e) {
        return (
          Rt(t, e.inputValue), qt(t, t, e), Dt(t, e), (t.type = e.input), t
        );
      }),
  ...
  var Nt = function (t, e) {
    ...
    zt = function (t, e) {
      if (e.icon || e.iconHtml) {
        ...
        if (e.iconHtml) o = Kt(e.iconHtml);
          ...
          o =
            '\n  <span class="swal2-x-mark">X</span>\n';
        else if (e.icon) {
          o = Kt({ question: "?", warning: "", info: "i", success: "✔" }[e.icon]);
        }
    ...
    Yt = function (t, e) {
      var n = e.showClass || {};
      (t.className = "".concat(A.popup, " ").concat(vt(t) ? n.popup : "")),
        e.toast
          ? (ct([document.documentElement, document.body], A["toast-shown"]),
            ct(t, A.toast))
          : ct(t, A.modal),
        ot(t, e, "popup"),
    ...
    $t = function (t) {
      ...
      return (
        ...
        t.progressStepsDistance && lt(e, "width", t.progressStepsDistance),
        e
      );
    },
    Jt = function (t, e) {
            ...
            o && 0 !== o.length && void 0 !== i
              ? (dt(n),
                ...
                o.forEach(function (t, r) {
                  ...
                  if (
                    (n.appendChild(a),
                    r === i && ct(a, A["active-progress-step"]),
                    r !== o.length - 1)
                  ) {
                    var c = $t(e);
                    n.appendChild(c);
  ...
  var ye = function (t) {
    ...
    var o = I();
    return (
      ut(o, n.showClass.backdrop), ct(o, n.hideClass.backdrop), ke(t, e, n), !0
    );
  };
  function we(t) {
  ...
  var Ce = function (t) {
      t.isAwaitingPromise &&
        (delete t.isAwaitingPromise, Lt.innerParams.get(t) || t._destroy());
    },
    Ae = function (t) {
      return void 0 === t
  ...
  function Ke(t, e) {
    ...
    if (n && t)
      if ("radio" === t.type)
        for (
          var o = n.querySelectorAll('[name="'.concat(A.radio, '"]')), i = 0;
          i < o.length;
          i++
        )
          o[i].disabled = e;
    ...
    On = Object.freeze({
      ...
      bindClickHandler: function () {
        (Tn[
          ...
          Bn || (document.body.addEventListener("click", Sn), (Bn = !0));
      },
            ...
            i(f, [
              {
                key: "_main",
                value: function (e, n) {
                  return l(r(f.prototype), "_main", this).call(
                    this,
                    e,
                    Object.assign({}, t, n)
                  );
    ...
    Kn = function (t, e, n) {
      ct(t, n.showClass.backdrop),
        ...
        n.heightAuto &&
          n.backdrop &&
          !n.toast &&
          ct([document.documentElement, document.body], A["height-auto"]);
    },
    Yn = {
      email: function (t, e) {
  ...
  var $n = new WeakMap(),
        ...
        ue.swalPromiseResolve.set(t, o),
          ...
          (e.denyButton.onclick = function () {
            !(function (t) {
              var e = Lt.innerParams.get(t);
              t.disableButtons(),
                e.returnInputValueOnDeny ? De(t, "deny") : Ve(t, !1);
            })(t);
          }),
          ...
          (function (t, e, n) {
            Qt(t),
              e.toast ||
                ...
                (t.keydownTarget = e.keydownListenerCapture ? window : q()),
    ...
    Gn = function (t, e) {
      var n = (function (t) {
          ...
          return (
            _n(n),
            Object.assign(Mn(n), In(n), Hn(n), Dn(n), qn(n), Vn(n), Rn(n, jn))
          );
        })(t),
